...
class SystemOutput extends React.Component {
  ...
  loadSuggestions(value) {
    this.props.searchOutputSystem(Helper.escapeRegexCharacters(value));
  }

  onSuggestionSelected = (event, {suggestion}) => {
    this.props.setOutputSystem(suggestion)
  };
  ...
  render() {
    ...
    return (<div className="inline-block-search">
      <Autocomplete
        suggestions={this.props.output_sugg}
