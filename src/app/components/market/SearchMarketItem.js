...
import { searchItem, addItem, resetSearch } from '../../actions/marketActions';
...
export default connect(state => state.marketReducer, { searchItem, addItem, resetSearch })(SearchMarketItem);
